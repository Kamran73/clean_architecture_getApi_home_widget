...
class _$_UserEntity extends _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, email: $email, firstName: $firstName, lastName: $lastName, profileImage: $profileImage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, firstName, lastName, profileImage);
